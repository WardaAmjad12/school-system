...
<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="{{asset('civic/css/bootstrap.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('civic/css/font-awesome.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('civic/css/flaticon.css')}}"/>
    <link rel="stylesheet" href="{{asset('civic/css/owl.carousel.css')}}"/>
    <link rel="stylesheet" href="{{asset('civic/css/magnific-popup.css')}}"/>
    <link rel="stylesheet" href="{{asset('civic/css/style.css')}}"/>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!--====== Javascripts & Jquery ======-->
    <script src="{{asset('civic/js/jquery-2.1.4.min.js')}}"></script>
    <script src="{{('civic/js/bootstrap.min.js')}}"></script>
    <script src="js/owl.carousel.min.js"></script>
    <script src="js/magnific-popup.min.js"></script>
    <script src="js/circle-progress.min.js"></script>
    <script src="{{asset('civic/js/main.js')}}"></script>
</body>
</html>